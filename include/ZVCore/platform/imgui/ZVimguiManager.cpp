...
namespace ZVLab {
	...
	void CZVimguiManager::Initialize(HANDLE hwnd, UsageExtensionsFlags flags)
	{
		const char* glsl_version = "#version 130";
	...
	{
#if (DZVEngine_Usage == DZVEngine_Usage_GLFW_OpenGL)
		ImGui_ImplOpenGL3_Shutdown();
		ImGui_ImplGlfw_Shutdown();
#elif (DZVEngine_Usage == DZVEngine_Usage_WIN32_OpenGL)
