...
extern "C" {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	int _ACSCLIB_ WINAPI acsc_SPDataCollectionStop(HANDLE Handle, int SP_Index, ACSC_WAITBLOCK* Wait);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	int _ACSCLIB_ WINAPI acsc_SPDataCollectionStart(HANDLE Handle, int Flags, const char* Array, int NSample, double Period, int SP_Index, int SP_Address1, int SP_Address2, int SP_Address3, int SP_Address4, ACSC_WAITBLOCK* Wait);

	//////////////////////////////////////////////////////////////////////////////////////////////////
	// The function reads address of the variable in the Servo Processor memory that is used for
	// Servo Processor Data Collection
	//////////////////////////////////////////////////////////////////////////////////////////////////
	int _ACSCLIB_ WINAPI acsc_GetSPAddress(HANDLE Handle, int Flags, int SP_Index, const char* SP_Variable, double* SP_Address, ACSC_WAITBLOCK* Wait);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	int _ACSCLIB_ WINAPI acsc_WaitSPDataCollectionEnd(HANDLE Handle, int Timeout, int SP_Index);
...
// function type definitions
	...
	typedef int (WINAPI *ACSC_SPDataCollectionStart)(HANDLE Handle, int Flags, const char* Array, int NSample, double Period, int SP_Index, int SP_Address1, int SP_Address2, int SP_Address3, int SP_Address4, ACSC_WAITBLOCK* Wait);
	typedef int (WINAPI *ACSC_SPDataCollectionStop)(HANDLE Handle, int SP_Index, ACSC_WAITBLOCK* Wait);
	typedef int (WINAPI *ACSC_GetSPAddress)(HANDLE Handle, int Flags, int SP_Index, const char* SP_Variable, double* SP_Address, ACSC_WAITBLOCK* Wait);
	...
	static int InitACSCLibrary()
	{
		...
		acsc_OpenCommSimulator = (ACSC_OpenCommSimulator)GetProcAddress(hACSCLibraryModule, "_acsc_OpenCommSimulator@0");										//     323
		...
		acsc_GetEtherCATSlaveVendorIDV2 = (ACSC_GetEtherCATSlaveVendorIDV2)GetProcAddress(hACSCLibraryModule, "_acsc_GetEtherCATSlaveVendorIDV2@20");			//     372
		acsc_GetEtherCATSlaveProductIDV2 = (ACSC_GetEtherCATSlaveProductIDV2)GetProcAddress(hACSCLibraryModule, "_acsc_GetEtherCATSlaveProductIDV2@20");		//     373
		acsc_GetEtherCATSlaveRevisionV2 = (ACSC_GetEtherCATSlaveRevisionV2)GetProcAddress(hACSCLibraryModule, "_acsc_GetEtherCATSlaveRevisionV2@20");			//     374
		...
		acsc_ReadString = (ACSC_ReadString)GetProcAddress(hACSCLibraryModule, "_acsc_ReadString@40");															//     380
		acsc_WriteString = (ACSC_WriteString)GetProcAddress(hACSCLibraryModule, "_acsc_WriteString@40");														//     381
		acsc_GetEtherCATSlavesCount = (ACSC_GetEtherCATSlavesCount)GetProcAddress(hACSCLibraryModule, "_acsc_GetEtherCATSlavesCount@16");					    //     382
		acsc_DynamicErrorCompensationOn = (ACSC_DynamicErrorCompensationOn)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationOn@16");			//     383
		acsc_DynamicErrorCompensationOff = (ACSC_DynamicErrorCompensationOff)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationOff@16");	    //     384
		acsc_DynamicErrorCompensationRemove = (ACSC_DynamicErrorCompensationRemove)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationRemove@16");	//     385
		acsc_DynamicErrorCompensation1D = (ACSC_DynamicErrorCompensation1D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation1D@44");		    //     386
		acsc_DynamicErrorCompensationN1D = (ACSC_DynamicErrorCompensationN1D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN1D@32");	    //     387
		acsc_DynamicErrorCompensationA1D = (ACSC_DynamicErrorCompensationA1D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationA1D@36");	    //     388
		acsc_FRF_FreeCrossCouplingOutput = (ACSC_FRF_FreeCrossCouplingOutput)GetProcAddress(hACSCLibraryModule, "_acsc_FRF_FreeCrossCouplingOutput@8");			//     389
		acsc_DynamicErrorCompensation2D = (ACSC_DynamicErrorCompensation2D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation2D@68");		    //     390
		acsc_DynamicErrorCompensationN2D = (ACSC_DynamicErrorCompensationN2D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN2D@44");	    //     391
		acsc_DynamicErrorCompensationA2D = (ACSC_DynamicErrorCompensationA2D)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationA2D@32");	    //     392
		acsc_DynamicErrorCompensation3D2 = (ACSC_DynamicErrorCompensation3D2)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation3D2@96");	    //     393
		acsc_DynamicErrorCompensation3D3 = (ACSC_DynamicErrorCompensation3D3)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation3D3@100");	    //     394
		acsc_DynamicErrorCompensation3D5 = (ACSC_DynamicErrorCompensation3D5)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation3D5@108");	    //     395
		acsc_DynamicErrorCompensation3DA = (ACSC_DynamicErrorCompensation3DA)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensation3DA@128");	    //     396
		acsc_DynamicErrorCompensationN3D2 = (ACSC_DynamicErrorCompensationN3D2)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN3D2@60");	    //     397
		acsc_DynamicErrorCompensationN3D3 = (ACSC_DynamicErrorCompensationN3D3)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN3D3@64");	    //     398
		acsc_DynamicErrorCompensationN3D5 = (ACSC_DynamicErrorCompensationN3D5)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN3D5@72");	    //     399
		acsc_DynamicErrorCompensationN3DA = (ACSC_DynamicErrorCompensationN3DA)GetProcAddress(hACSCLibraryModule, "_acsc_DynamicErrorCompensationN3DA@92");	    //     400
		acsc_PegIncNTV2 = (ACSC_PegIncNTV2)GetProcAddress(hACSCLibraryModule, "_acsc_PegIncNTV2@96");															//	   401
		acsc_PegRandomNTV2 = (ACSC_PegRandomNTV2)GetProcAddress(hACSCLibraryModule, "_acsc_PegRandomNTV2@88");												    //	   402
		acsc_SPDataCollectionStart = (ACSC_SPDataCollectionStart)GetProcAddress(hACSCLibraryModule, "_acsc_SPDataCollectionStart@48");							//	   403
		acsc_SPDataCollectionStop = (ACSC_SPDataCollectionStop)GetProcAddress(hACSCLibraryModule, "_acsc_SPDataCollectionStop@12");								//	   404
		acsc_GetSPAddress = (ACSC_GetSPAddress)GetProcAddress(hACSCLibraryModule, "_acsc_GetSPAddress@24");														//	   405
		acsc_WaitSPDataCollectionEnd = (ACSC_WaitSPDataCollectionEnd)GetProcAddress(hACSCLibraryModule, "_acsc_WaitSPDataCollectionEnd@12");					//	   406
