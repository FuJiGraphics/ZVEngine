...
class AFX_EXT_CLASS CzvMotion_Virtual final : public CzvMotion
{
	////member variables
protected:
	void* m_pVoidMotion;
...
public:
	CzvMotion_Virtual();
	virtual ~CzvMotion_Virtual();
	CzvMotion_Virtual(CzvMotion_Virtual& MotionSrc) = delete;
	CzvMotion_Virtual& operator=(CzvMotion_Virtual& MotionSrc) = delete;
...
extern "C"
{
	AFX_EXT_API extern CzvMotion* CreateMotionVirtual();
}
