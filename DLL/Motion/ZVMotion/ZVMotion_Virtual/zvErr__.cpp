...
CString CzvErr__::GetName(EzvErr ezvErr)
{
	...
	if (CzvMotion_VirtualCfg::GetLanguage() == zvStrKorean) return m_rgstrKor[uiIndex];
	else if (CzvMotion_VirtualCfg::GetLanguage() == zvStrChinese) return m_rgstrChn[uiIndex];
