#pragma once
class AFX_EXT_CLASS CzvMotion_Ajin final : public CzvMotion
{
	////member variables
protected:
	void* m_pzvMotion_Ajin__;
...
public:
	CzvMotion_Ajin();
	~CzvMotion_Ajin();
	CzvMotion_Ajin(CzvMotion_Ajin& MotionSrc) = delete;
	CzvMotion_Ajin& operator=(CzvMotion_Ajin& MotionSrc) = delete;
...
extern "C"
{
	AFX_EXT_API extern CzvMotion* CreateMotionAjin();
}